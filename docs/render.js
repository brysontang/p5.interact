  ...
  document.body.innerHTML = `
    <div class="layout">
      ...
      <main class="ref">
        ...
        <p>Five questions you can ask inside <code>draw()</code>, each applying to the shapes drawn after it until the end of the enclosing <code>push()</code> / <code>pop()</code>, the way <code>describeElement()</code> scopes itself. Questions asked back to back share the shapes that follow; a question asked after a shape starts a new group, so questions work the way <code>fill()</code> works and rarely need <code>push()</code> at all. No ids, no handles, no registration. State lives in your variables.</p>
        <pre class="sig">${esc(`<script src="https://cdn.jsdelivr.net/npm/p5@2.3.1/lib/p5.js"></script>
<script src="https://cdn.jsdelivr.net/npm/p5.interact@0.1.1/p5.interact.js"></script>`)}</pre>
        <p><a href="https://github.com/brysontang/p5.interact">github.com/brysontang/p5.interact</a> · <a href="https://www.npmjs.com/package/p5.interact">npm</a> · MIT</p>
        <ul class="index-list">
